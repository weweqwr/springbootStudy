...
//    @RequiresPermissions("rotation")
    ...
    //禁用和启动
    @RequiresPermissions("rotation")
    @RequestMapping(value = "sheildRotation",method = RequestMethod.POST)
    public Map<String,Object> sheildRotation(@RequestBody Gw_rotation rotation) {
        Map<String,Object> map=rotatioServe.sheildRotation(rotation.getId(),rotation.getState());
        return map;
    }
    //按小程序展示查询
