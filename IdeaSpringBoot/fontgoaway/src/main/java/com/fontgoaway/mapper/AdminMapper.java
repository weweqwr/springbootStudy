...
public interface AdminMapper {
    ...
    //修改账号信息
    void updateAdminInfo(@Param("avatarUrl")String avatarUrl,@Param("username")String username,@Param("gender")int gender,@Param("province")String province,@Param("city")String city,@Param("area")String area,@Param("detailAdd")String detailAdd,@Param("phone")String phone,@Param("account")String account);
}
